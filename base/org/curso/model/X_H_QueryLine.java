...
public class X_H_QueryLine extends PO implements I_H_QueryLine, I_Persistent 
{
	...
	public I_H_Affliction getH_Affliction() throws RuntimeException
    {
		return (I_H_Affliction)MTable.get(getCtx(), I_H_Affliction.Table_Name)
			.getPO(getH_Affliction_ID(), get_TrxName());	}

	/** Set Affliction.
		@param H_Affliction_ID Affliction	  */
	...
	/** Set QueryLine.
		@param H_QueryLine_ID QueryLine	  */
